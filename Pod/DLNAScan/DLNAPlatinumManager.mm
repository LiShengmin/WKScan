...
#pragma mark-PLT_MediaItemIDFinder.h
...
#pragma mark-PLT_MicroMediaController.h
...
public:
    ...
    PLT_MicroMediaController(PLT_CtrlPointReference& ctrlPoint, DLNAPlatinumManager * delegateWrapper);
...
/*----------------------------------------------------------------------
 ...
 +---------------------------------------------------------------------*/
PLT_MicroMediaController::PLT_MicroMediaController(PLT_CtrlPointReference& ctrlPoint,DLNAPlatinumManager * delegateWrapper) :
...
PLT_MicroMediaController::OnMRRemoved(PLT_DeviceDataReference& device)
{
    ...
    if(m_Target.delegate && [m_Target.delegate respondsToSelector:@selector(remove_device)])
    {
˜    }
}
